  ...
  principais atributos do contexto. Para \citeonline{lee2008time}, o tempo é usado para gerar avaliação implícita para um histórico de
  ...
  Outra pesquisa relacionada foi a de \citeonline{ding2005time}. Nesta pesquisa, um
  ...
  \citeonline{ding2005time}. Este modelo foi proposto no artigo de \citeonline{basile2015modeling}, onde basicamente itens mais antigos não tem seu peso puramente descartado, e sim caso
  ...
  Por fim, um famoso trabalho que usa o contexto de tempo para recomendação se dá na pesquisa de \citeonline{koren2010collaborative}, que apresenta o modelo de recomendação
  ...
  dos filmes realizados pelos usuários em um modelo similar a pesquisa de \citeonline{basile2015modeling}
  ...
  O projeto também utiliza tanto estratégias \textit{offline} e testes de
  usuário para validar as recomendações implementadas, sendo que as estratégias
  \textit{offline} têm como base a análise de curvas ROC
  (\textit{Receiver Operator Characteristic Curve}), que analisa a taxa de
  itens recomendados pelo sistema e que estão presentes nos dados de teste,
  sobre a taxa de itens não recomendados mas que estão presentes nos dados de
  teste, enquanto os testes de usuário visam analisar principalmente a precisão
